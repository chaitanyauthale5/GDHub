...
import {
  Presence
} from "./chunk-BHHLVSFY.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-M2FZWWVF.js";
import {
  Presence
  ...
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime.jsx)(Combination_default, {
        as: Slot, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime.jsx)(
          Primitive.div,
          {
            "data-state": getState(context.open),
            ...overlayProps,
