  ...
  return (
    <div className="h-screen bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 p-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 bg-gray-900">
        {/* Local */}
        <div className={`relative rounded-xl overflow-hidden bg-gray-800 aspect-video ${speakingUid && localUserId && speakingUid === localUserId ? 'outline outline-4 outline-green-400' : ''}`} data-speaking={speakingUid && localUserId && speakingUid === localUserId ? '1' : '0'}>
          {localStream ? (
